  ...
  <StyledFadeInEnteringCard className={className}>
    <PictureBlock>
      ...
      <PictureBlock.Body>
        ...
        <br />
        現代は、モノ・サービスがあふれる時代であり、沢山の価値観が認められる（筈）の社会なのに、ふと世の中を見渡してみると、意外と古くからの固定概念がまかり通ってる気がしています。『温故』もちろん、そんなサービスも大切です。素晴らしいサービスも沢山あります。『知新』だけど、今までに無いサービス、誰もが『輝ける』サービス。
        <br />
