  ...
  <DefinitionCard>
    <DefinitionBlock>
      ...
      <DefinitionBlock.Body>
        ...
        <StyledLine>
          このelchikaは、エイミーの次期プロダクトを決めるコンペティションを社内で開き、開発が決まったプロダクトになります。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>
          elchikaが目指している市場においての役割は、「個人、企業問わずモノづくりの知識を共有し、交流が生まれ、イノベーションが起きる」そんなプラットフォームです。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>
          しかしながら、現在はまだその役割を果たせていないのが実情です。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>その理由の一つに『人材』の課題が挙げられます。</StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>
          実は、コンペティションでelchikaを提案し牽引していたメンバーが退職し、現在推進力が落ちている状態となっています。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>
          そのため、今後elchikaが市場で役割を担うプロダクトに成長するには、新たにelchikaを牽引してくださる人材が必要になると考え、この度プロダクトマネージャーを募集することとなりました。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>
          お任せする業務は企画から広報、開発の進捗管理など多岐にわたりますが、まだまだ世に知られているとは言い難いプロダクトを裁量を持って成長させていく醍醐味を味わえるポジションになります。
        </StyledLine>
      </DefinitionBlock.Body>
    </DefinitionBlock>
    <DefinitionBlock>
      <DefinitionBlock.Header>募集にあたって</DefinitionBlock.Header>
      <DefinitionBlock.Body>
        <StyledLine>
          今回募集のプロダクトマネージャーには、「電子工作に限らず、自分の知識や経験を『日本のモノづくり』をサポートしていきたい」という気持ちが大切になります。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>
          まだ認知度の低いプロダクトを牽引していくことは、困難な道のりかもしれません。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>
          裁量も大きく、簡単に務まるポジションとご案内することはできません。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>
          それでも、結果が出たときは、既に出来上がったプロダクトを拡充させていくのとは違う感動が待っていると思います。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>
          今まで培ってきた知識や経験、『想い』を日本のモノづくりをサポートするために発揮してくださる方の応募をお待ちしております。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
    ...
    <DefinitionBlock>
      ...
      <DefinitionBlock.Body>
        <StyledLine>
          電子工作やIoTが好きで（趣味の範囲でも）自ら製作していること
        </StyledLine>
        <StyledLine>経営的視点を持って運営に携われる方</StyledLine>
    ...
    <DefinitionBlock>
      ...
      <DefinitionBlock.Body>
        <StyledLine>
          市場戦略（日本のモノづくりをバックアップ）を提案できる方
        </StyledLine>
        <StyledLine>
          PG、SE等での開発経験（後述する開発環境下での経験を有する場合、開発業務をお任せする可能性があります）
        </StyledLine>
        <StyledLine>営業経験</StyledLine>
        <StyledLine>提案、プレゼンテーション能力</StyledLine>
      </DefinitionBlock.Body>
    </DefinitionBlock>
    <DefinitionBlock>
      ...
      <DefinitionBlock.Body>
        <StyledLine>
          <b>言語</b>: JavaScript(ESNext), TypeScript, HTML5, CSS3(SCSS,
          PostCSS)
        </StyledLine>
        <StyledLine>
          <b>フレームワーク</b>: Node.js, Vue.js, React(class-based, hooks),
          Storybook, GatsbyJS, Webpack
        </StyledLine>
        <StyledLine>
          <b>DB</b>: PostgreSQL, Redis
        </StyledLine>
        <StyledLine>
          <b>クライアント</b>: Electron
        </StyledLine>
        ...
        <StyledLine>
          <b>インフラ</b>: Docker, GitHub, GCP(GKE, Storage, Container Registry,
          DNS, SQL, Memorystore, Functions, Scheduler), Kubernetes, Netlify,
          GitHub(Pages, Actions, Packages), Algolia, Mailgun, Cloudinary
        </StyledLine>
      </DefinitionBlock.Body>
    </DefinitionBlock>
    <DefinitionBlock>
    ...
    <DefinitionBlock>
      <DefinitionBlock.Header>評価制度</DefinitionBlock.Header>
      <DefinitionBlock.Body>
        <StyledLine>
        ...
        <StyledLine>
          エイミーでは、今後の未来において「社員自身がキャリアの選択肢を持つ」ことがより重要になってくると考えています。そのため、給与見直しのタイミング（4月、10月）に外部機関に市場価値の算出を依頼し、その結果（高く評価されたスキルや、市場価値を高めるアドバイスなども含む）を半年間の給与の基準値としています。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>
          <b>社内価値（3Arrival + 4Drive）</b>
        </StyledLine>
        <StyledLine>
          企業理念「みんなが輝く多様な未来を創る」という理想を実現するために大切な価値観（3Arrival
          + 4Drive）を、社内価値の評価基準としています。
        </StyledLine>
        <StyledLine>
          <br />
        </StyledLine>
        <StyledLine>
          <b>3Arrival：理想への道を築き上げる力</b>
        </StyledLine>
        <StyledLine>
          挑戦（ベンチャーマインド）を忘れず、困難を恐れず、理想の実現に向けて一丸となって進むためスキル
        </StyledLine>
        <StyledLine>
        ...
        <StyledLine>
          <b>4Drive：築いた道を突き進む力</b>
        </StyledLine>
        <StyledLine>
          3Arrivalで見据えた道を突き進むために必要な課題をクリアするためのスキル
        </StyledLine>
        <StyledLine>
